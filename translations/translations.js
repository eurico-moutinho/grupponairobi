window.translations = {
  en: {
    ...
    timeline_walls: "Fillings",
    timeline_walls_desc: "Wall construction and interior work",
    timeline_floor: "Floor Coverings",
    timeline_floor_desc: "Safe and durable flooring",
    timeline_electric: "Electric",
    timeline_electric_desc: "Electrical systems and lighting",
    timeline_water: "Water",
    timeline_water_desc: "Plumbing and water systems",
    timeline_windowsdoors: "Windows And Doors",
    timeline_windowsdoors_desc: "Final touches for completion",
  ...
  it: {
    ...
    timeline_windowsdoors_desc: "Finiture finali per il completamento",
  ...
  de: {
    ...
    timeline_walls_desc: "Wandbau und Innenarbeiten",
    timeline_floor: "Bodenbeläge",
    timeline_floor_desc: "Sichere und langlebige Böden",
    timeline_electric: "Elektroinstallation",
    timeline_electric_desc: "Beleuchtung, Steckdosen und elektrische Anlagen",
    timeline_water: "Wasserinstallation",
    timeline_water_desc: "Anschluss des Gebäudes an die Wasserversorgung",
    timeline_windowsdoors: "Fenster und Türen",
    timeline_windowsdoors_desc: "Letzte Arbeiten zur Fertigstellung",
